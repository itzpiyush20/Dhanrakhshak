  ...
  return (
    <div className="relative w-full max-w-[480px] sb-card-light p-6 flex flex-col gap-5 overflow-hidden select-none">
      ...
      <div className="flex items-center justify-between border-b border-sb-hairline pb-3">
        ...
        <span className="text-[11px] font-mono text-sb-ink-muted bg-sb-canvas px-2 py-0.5 rounded border border-sb-hairline">
          {step === 0 ? 'READY' : step === 1 ? 'ALERT_IN' : step === 2 ? 'PARSING' : step === 3 ? 'DB_COMMIT' : 'SYNCED'}
        </span>
      </div>

      <div className="flex flex-col gap-2">
        <span className="text-[11px] font-semibold tracking-widest text-sb-ink-muted uppercase">1 · Incoming Bank Alert</span>
        <div className="relative min-h-[92px] bg-sb-canvas rounded-xl border border-sb-hairline p-3 pb-7 overflow-hidden flex flex-col justify-center">
            ...
            <div className={cn('flex gap-3 items-start transition-all duration-700', step >= 1 ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-2', step === 2 && 'pulse-emerald')}>
              ...
              <div className="flex-1 min-w-0">
                <div className="flex justify-between items-center mb-1">
                  <span className="text-xs font-semibold text-sb-ink">Email · ICICI Bank</span>
      ...
      <div className="flex flex-col gap-2">
        <span className="text-[11px] font-semibold tracking-widest text-sb-ink-muted uppercase">2 · Logged Automatically</span>
        <div className="border border-sb-hairline rounded-xl overflow-hidden bg-sb-canvas">
          <div className="grid grid-cols-4 bg-sb-canvas border-b border-sb-hairline px-3 py-2 text-[11px] font-semibold text-sb-ink-muted tracking-widest uppercase">
          ...
          <div className="divide-y divide-sb-hairline min-h-[90px]">
            {step >= 3 && (
              <div className="grid grid-cols-4 px-3 py-2 text-xs items-center bg-brand-500/10 animate-insert">
                <div className="text-sb-ink-muted font-mono text-[11px]">Today</div>
                <div className="col-span-2">
                  <div className="font-semibold text-sb-ink">Starbucks</div>
                  <div className="text-[11px] text-brand-400">Food & Dining</div>
                </div>
            ...
            <div className="grid grid-cols-4 px-3 py-2 text-xs items-center">
              <div className="text-sb-ink-muted font-mono text-[11px]">Yest.</div>
            ...
            <div className="grid grid-cols-4 px-3 py-2 text-xs items-center">
              <div className="text-sb-ink-muted font-mono text-[11px]">Jun 4</div>
              <div className="col-span-2"><div className="font-medium text-sb-ink">Zomato</div><div className="text-[11px] text-sb-ink-muted">Food & Dining</div></div>
      ...
      <div className="flex flex-col gap-2">
        <span className="text-[11px] font-semibold tracking-widest text-sb-ink-muted uppercase">3 · Budget Update</span>
