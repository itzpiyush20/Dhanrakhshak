    ...
    <div className="min-h-screen bg-sb-canvas text-sb-ink-secondary" style={{ fontFamily: "'Inter', -apple-system, system-ui, sans-serif" }}>
      ...
      <main className="max-w-4xl mx-auto px-6 py-16">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center h-20 w-20 rounded-[12px] bg-brand-500/10 border border-brand-500/20 text-4xl mb-6">
            🛡️
          </div>
          <h1 className="text-4xl font-extrabold tracking-tight text-sb-ink">
            Built for Financial Clarity
          </h1>
          <p className="text-base mt-4 max-w-2xl mx-auto text-sb-ink-secondary">
        ...
        {/* Mission */}
        <div className="sb-card-light border-t-4 border-t-brand-500 p-8 mb-12">
          ...
          <div className="grid sm:grid-cols-3 gap-4 mt-8">
            {[
              ...
              <div key={item.title} className="rounded-xl p-5 bg-sb-canvas border border-sb-hairline">
        ...
        <section className="mb-12 space-y-6">
          <h2 className="text-xl font-bold text-sb-ink">Why Dhanrakshak Exists</h2>
          <div className="space-y-4">
            {[
              ...
              <div key={item.q} className="sb-card-light p-6">
        ...
        {/* Technology */}
        <section className="mb-12 space-y-6">
          <h2 className="text-xl font-bold text-sb-ink">Technology & Architecture</h2>
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={item.label} className="sb-card-light p-4">
        ...
        {/* Trust Signals */}
        <section className="mb-12 space-y-6">
          <h2 className="text-xl font-bold text-sb-ink">Our Commitments to You</h2>
          <div className="grid sm:grid-cols-2 gap-3">
            {[
              ...
              <div key={commitment} className="flex items-center gap-3 sb-card-light px-4 py-3 text-sm font-medium text-sb-ink-secondary">
